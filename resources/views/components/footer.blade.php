<div class="container py-3">
    <div class="row g-5">
        <div class="col-md-7 col-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a href="/" class="navbar-brand">
                <span style="
                    ...
                    margin: 0.2em 0;
                ">
                    <span style="vertical-align:middle;">কোডার পেশাজীবী সমবায় সমিতি লিঃ</span>
                </span>
            </a>
            <p class="mb-0">নিবন্ধন নং- দশ-৭৯৫৯</p>
            <p class="mb-0">আমাদের সমবায় সমিতির মাধ্যমে একসাথে এগিয়ে চলুন - Let's move forward together through our cooperative society</p>
        </div>
        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
            <h5 class="text-white mb-4">Get In Touch (যোগাযোগ করুন)</h5>
            <p><i class="fa fa-map-marker-alt me-3"></i>১০/এ-৩, (৮ম তলা) বর্ধন বাড়ি, দারুস সালাম থানা, মিরপুর, ঢাকা-১২১৬</p>
            <p><i class="fa fa-phone-alt me-3"></i>+880 1712-345678, +880 1987-654321</p>
            <p><i class="fa fa-envelope me-3"></i>info@cpssl.org</p>
        ...
        <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
            ...
            <a class="btn btn-link" href="/">Home (প্রচ্ছদ)</a>
            <a class="btn btn-link" href="/registration">Registration (নিবন্ধন)</a>
            <a class="btn btn-link" href="/login">Login (লগইন)</a>
            <a class="btn btn-link" href="/contact">Contact (যোগাযোগ)</a>
