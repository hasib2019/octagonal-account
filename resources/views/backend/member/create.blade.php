	...
	<div class="row">
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">{{ _lang('Permanent Address') }}</label>                        
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">{{ _lang('NID Image') }}</label>                        
                                <input type="file" class="form-control dropify" name="nid_image" >
                            </div>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mt-4">
                <div class="card-header">
                    <div class="togglebutton">
                        <h4 class="header-title d-flex align-items-center">{{ _lang('Account Details') }}&nbsp;&nbsp;
                            <input type="checkbox" id="create_account" value="1" name="create_account">
                        </h4>
                    </div>
                </div>
                <div class="card-body" id="create_account_card">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control float-field" name="opening_balance" value="{{ old('opening_balance') }}">
                            </div>
                        </div>
                    </div>
                </div>
