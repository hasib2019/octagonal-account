...
class MemberController extends Controller {
	...
	public function store(Request $request) {
		$validator = Validator::make($request->all(), [
			...
			//Account Create
			'account_number' => 'required_if:create_account,1|unique:savings_accounts|max:50',
			'savings_product_id' => 'required_if:create_account,1',
			'opening_balance' => 'required_if:create_account,1|numeric',
		], [
